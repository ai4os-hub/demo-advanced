...
exclusive to the deepaas_full package. You can use the `config.py`
...
MODELS_PATH = os.getenv("DEEPAAS_FULL_MODELS_PATH", BASE_PATH / "models")
MODELS_PATH = Path(MODELS_PATH)
# Path definition for data folder
DATA_PATH = os.getenv("DEEPAAS_FULL_DATA_PATH", BASE_PATH / "data")
DATA_PATH = Path(DATA_PATH)

# Configuration of model framework features
LABEL_DIMENSIONS = int(os.getenv("DEEPAAS_FULL_LABEL_DIMENSIONS", "10"))
IMAGE_SIZE = int(os.getenv("DEEPAAS_FULL_IMAGE_SIZE", default="28"))
